...
public class SearchAction : GhostAction
{
	...
	private GhostNode GetHighestPriorityNodeToSearch()
	{
		...
		for (int i = 0; i < searchNodesOnLayer.Length; i++)
		{
			float num2 = time - searchNodesOnLayer[i].searchData.lastSearchTime;
			num += num2;
		}
