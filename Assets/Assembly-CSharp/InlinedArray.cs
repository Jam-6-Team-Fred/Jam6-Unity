...
public struct InlinedArray<TValue> : IEnumerable<TValue>, IEnumerable
{
	private struct Enumerator : IEnumerator, IDisposable, IEnumerator<TValue>
	{
	...
	public InlinedArray(IEnumerable<TValue> values)
	{
		...
		length = Enumerable.Count(values);
		if (length > 1)
		{
