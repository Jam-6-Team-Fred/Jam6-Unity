...
public class SliderElement : MenuValueOption, IEventSystemHandler, IMoveHandler
{
	public delegate void ValueChangedEvent();

	private const int c_minValue = 0;

	private const int c_maxValue = 10;

	private const bool c_wholeNumbers = true;
	...
	public override void Initialize(int startingValue)
	{
		...
		Navigation navigation = _rootSelectable.navigation;
