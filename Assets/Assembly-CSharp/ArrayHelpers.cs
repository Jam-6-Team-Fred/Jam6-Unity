...
public static class ArrayHelpers
{
	...
	public static int Append<TValue>(ref TValue[] array, IEnumerable<TValue> values)
	{
		if (array == null)
		{
			array = Enumerable.ToArray(values);
			return 0;
		}
		int num = array.Length;
		int num2 = Enumerable.Count(values);
	...
	{
		MemoryHelpersSwap(ref array[index1], ref array[index2]);
	}

	public static void MemoryHelpersSwap<TValue>(ref TValue a, ref TValue b)
	{
		TValue val = a;
		a = b;
		b = val;
