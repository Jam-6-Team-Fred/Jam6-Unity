...
namespace UnityEngine.UI
{
	public class ScrollRectFixedSizeHandle : ScrollRect
	{
		...
		protected override void LateUpdate()
		{
			base.LateUpdate();
			UpdateAutoScroll();
			if ((bool)base.horizontalScrollbar)
			{
		...
		public void UpdateAutoScroll(bool forceAutoscroll = false)
		{
			if (!base.transform.gameObject.activeInHierarchy || EventSystem.current == null)
			{
				return;
			}
			if (contentPanel == null)
			{
				contentPanel = base.content;
			}
