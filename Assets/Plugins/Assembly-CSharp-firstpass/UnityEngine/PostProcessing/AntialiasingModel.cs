...
namespace UnityEngine.PostProcessing
{
	...
	public class AntialiasingModel : PostProcessingModel
	{
		...
		{
			[Tooltip("Lower quality is faster at the expense of visual quality (Low = ~60%, Medium = ~80%, High = ~95%, Ultra = ~99%).")]
			public SmaaPreset preset;

			public static SmaaSettings defaultSettings
			{
				get
				{
					SmaaSettings result = default(SmaaSettings);
					result.preset = SmaaPreset.MediumQuality;
					return result;
				}
			}
		}
		...
		public struct Settings
		{
			...
			public SmaaSettings smaaSettings;
			...
			public static Settings defaultSettings
			{
				get
				{
					...
					result.smaaSettings = SmaaSettings.defaultSettings;
