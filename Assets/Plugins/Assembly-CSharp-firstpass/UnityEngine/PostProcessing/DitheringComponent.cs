namespace UnityEngine.PostProcessing
{
	public sealed class DitheringComponent : PostProcessingComponentRenderTexture<DitheringModel>
	{
		private static class Uniforms
		{
			...
			internal static readonly int _DitheringStrength = Shader.PropertyToID("_DitheringStrength");
		}
		...
		public override bool active
		{
			get
			{
				if (base.model.enabled && base.model.settings.strength > 0f)
				{
		...
		public override void Prepare(Material uberMaterial)
		{
			...
			uberMaterial.SetFloat(Uniforms._DitheringStrength, base.model.settings.strength);
		}
	}
}
