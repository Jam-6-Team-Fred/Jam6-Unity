...
namespace UnityEngine.PostProcessing
{
	...
	public class ScreenSpaceReflectionModel : PostProcessingModel
	{
		...
		public struct ReflectionSettings
		{
			...
			[Tooltip("Minimum smoothness value that will have reflection applied. Increase this to have SSR run faster, but at the cost of losing reflections on rougher surfaces.")]
			[Range(0f, 1f)]
