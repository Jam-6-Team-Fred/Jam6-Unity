namespace UnityEngine.PostProcessing
{
	public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
	{
		...
		private Color[] m_pixelsCache = new Color[256];
		...
		{
			bool flag = base.model.needsCurvesRebuild;
			...
			for (int i = 0; i < 128; i++)
			{
				...
				m_pixelsCache[i] = new Color(r, g, b, a);
				...
				m_pixelsCache[i + 128] = new Color(r2, g2, b2, a2);
			}
			m_GradingCurves.SetPixels(m_pixelsCache);
		...
		public override void Prepare(Material uberMaterial)
		{
			if (base.model.isDirty || !IsLogLutValid(base.model.bakedLut))
			{
				...
				base.model.needsCurvesRebuild = false;
			}
