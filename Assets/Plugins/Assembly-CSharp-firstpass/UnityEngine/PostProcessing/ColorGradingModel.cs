...
namespace UnityEngine.PostProcessing
{
	...
	public class ColorGradingModel : PostProcessingModel
	{
		...
		public bool needsCurvesRebuild { get; internal set; }
		...
		{
			isDirty = true;
			needsCurvesRebuild = true;
		}

		public void SetBasicSettings(BasicSettings newSettings)
		{
			if (!isDirty)
			{
				isDirty |= !Mathf.Approximately(m_Settings.basic.temperature, newSettings.temperature);
				isDirty |= !Mathf.Approximately(m_Settings.basic.tint, newSettings.tint);
				isDirty |= !Mathf.Approximately(m_Settings.basic.hueShift, newSettings.hueShift);
				isDirty |= !Mathf.Approximately(m_Settings.basic.saturation, newSettings.saturation);
				isDirty |= !Mathf.Approximately(m_Settings.basic.contrast, newSettings.contrast);
			}
			m_Settings.basic = newSettings;
		}
	}
}
